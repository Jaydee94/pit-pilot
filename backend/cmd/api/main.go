...
func main() {
	...
	router := httpapi.NewRouter(httpapi.Deps{
		Auth:     &httpapi.AuthHandlers{Users: users, Sessions: sessions, CookieSecure: cfg.CookieSecure, GoogleClientID: cfg.GoogleClientID, AllowDevLogin: cfg.AllowDevLogin},
